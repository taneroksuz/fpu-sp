...
begin
  ...
  lzc1_32_comp : component lzc_32
    port map (
      a => lzc1_32_i.a,
      z => lzc1_32_o.c
    );

  lzc2_32_comp : component lzc_32
    port map (
      a => lzc2_32_i.a,
      z => lzc2_32_o.c
    );

  lzc3_32_comp : component lzc_32
    port map (
      a => lzc3_32_i.a,
      z => lzc3_32_o.c
    );

  lzc4_32_comp : component lzc_32
    port map (
      a => lzc4_32_i.a,
      z => lzc4_32_o.c
    );

  lzc_128_comp : component lzc_128
    port map (
      a => lzc_128_i.a,
      z => lzc_128_o.c
    );

  fp_ext1_comp : component fp_ext
    port map (
      fp_ext_i => fp_ext1_i,
      fp_ext_o => fp_ext1_o,
      lzc_o    => lzc1_32_o,
  ...
  fp_cmp_comp : component fp_cmp
    port map (
      fp_cmp_i => fp_cmp_i,
      fp_cmp_o => fp_cmp_o
    );

  fp_rnd_comp : component fp_rnd
    port map (
      fp_rnd_i => fp_rnd_i,
      fp_rnd_o => fp_rnd_o
    );

  fp_cvt_comp : component fp_cvt
    port map (
  ...
  fp_sgnj_comp : component fp_sgnj
    port map (
      fp_sgnj_i => fp_sgnj_i,
      fp_sgnj_o => fp_sgnj_o
    );

  fp_max_comp : component fp_max
    port map (
      fp_max_i => fp_max_i,
      fp_max_o => fp_max_o
    );

  fp_fma_comp : component fp_fma
    port map (
      reset    => reset,
      clock    => clock,
      fp_fma_i => fp_fma_i,
  ...
  fp_mac_comp : component fp_mac
    port map (
      fp_mac_i => fp_mac_i,
      fp_mac_o => fp_mac_o
    );

  fp_fdiv_comp : component fp_fdiv
    port map (
      reset     => reset,
      clock     => clock,
      fp_fdiv_i => fp_fdiv_i,
