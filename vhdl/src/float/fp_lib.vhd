...
package fp_lib is
  ...
  end component fp_max;

  component fp_sgnj is
    port (
      fp_sgnj_i : in    fp_sgnj_in_type;
      fp_sgnj_o : out   fp_sgnj_out_type
    );
  end component fp_sgnj;
